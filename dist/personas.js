...
// ── Template generators ──────────────────────────────────────────
function generateIdentity(agent) {
    return `# Identity
...
function generateHeartbeat(agent) {
    return `# HEARTBEAT.md
...
function generateBootstrap(agent) {
...
function generateMemory(agents) {
